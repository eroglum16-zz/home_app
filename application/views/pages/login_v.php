...
<head>
    ...
    <title>Ev Uygulaması - Kullanıcı Girişi </title>
...
<body style="background-image: url(<?php echo base_url("assets/images/home2.png");?>);">
    <div id="wrapper">
        ...
        <div class="row">
            <div class="col-md-3 col-md-offset-5">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="background-color: #854442">
                        <h3 class="panel-title text-center" style="color:white">Kullanıcı Bilgileri</h3>
                    </div>
                    <div class="panel-body">
                        <?php $this->session->set_flashdata('redirect',$redirect) ?>
                        <form role="form" action="<?php echo site_url("/login/check_login"); ?>" method="post" >
                            <fieldset>
                                ...
                                <button type="submit" name="submit" class="btn btn-lg btn-info btn-block"> Giriş Yap </button>
                            </fieldset>
                        </form>
                    </div>
                    <p class="text-center" ><a style="color: #854442; text-decoration: underline;" href="" data-toggle="modal" data-target="#myModal" >Kayıt Ol</a></p>
                    <p class="text-center" style="color: white; background-color: #5cb85c";><?php echo $validationError; ?></p>
                </div>
            </div>
        </div>
    </div>
	...
	<div id="myModal" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header text-center" style="background-color: #854442">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title" style="color:white">Kayıt Formu</h4>
	      </div>
	      <div class="modal-body">
	        <?php $this->load->view("pages/register_v"); ?>
	      </div>
